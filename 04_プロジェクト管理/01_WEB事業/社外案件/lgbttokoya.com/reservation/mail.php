...
$to = "ai.tarou39@gmail.com,idoko-room@i.softbank.jp,m.suzuki@mid-group.info";
...
$BccMail = "lgbt.1world.family@gmail.com";

// 管理者宛に送信されるメールのタイトル（件名）
$subject = "LGBT床屋のご予約お問い合わせ ";
...
$require = array('お名前','メールアドレス','ご希望日時');
...
$refrom_name = "LGBTフレンドり床屋IDOYA";

// 差出人に送信確認メールを送る場合のメールのタイトル（上記で1を設定した場合のみ）
$re_subject = "お問い合わせありがとうございます。【IDOYA】";
...
LGMTフレンドリー床屋IDOYAへのお問い合わせをいただきまして
誠にありがとうございます。
...
<div class="section1">
<p><?php echo $errm; ?></p>
<div class="btnLayout"><input type="button" value=" 前画面に戻る " onClick="history.back()"></div>
